...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Tebrikler!! Gece  Music Bot başarıyla başladı!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("kafam_kyamet")
            await ASS_CLI_1.join_chat("Richard_Ramirezzblog")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("kafam_kyamet")
            await ASS_CLI_2.join_chat("Richard_Ramirezzblog")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("kafam_kyamet")
            await ASS_CLI_3.join_chat("Richard_Ramirezzblog")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("kafam_kyamet")
            await ASS_CLI_4.join_chat("Richard_Ramirezzblog")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("kafam_kyamet")
            await ASS_CLI_5.join_chat("Richard_Ramirezzblog")
        except:
            pass
